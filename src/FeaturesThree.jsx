  ...
  return (
    <section className='md:mt-[115px] px-4'>
      <div className='container mx-auto max-w-[859px] flex flex-col md:flex-row lg:gap-[24px] lg:space-x-[125px]'>
        <div className=''>
          <h1 className='featuresone max-w-[379px] font-bold leading-[20px] text-[22px] lg:leading-[37px] lg:text-[28px] text-[#181818] mt-[42px]'>
            It’s like having Your Recruitment on autopilot
          </h1>
          <p className='max-w-[410px] max-h-[81px] text-[16px] font-medium leading-[27px] text-[#000C2D] mt-[24px] tracking-[0.01em]'>
